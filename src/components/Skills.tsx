...
export const Skills: React.FC = () => {
  ...
  // Updated skill categories with React Icons
  const skillCategories: SkillCategory[] = [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'LoRa', icon: <Radio size={iconSize} color={iconColor} /> },
    ...
    >
      <Container maxWidth="lg">
        ...
        >
          ...
          >
            I specialize in a range of technologies from cloud infrastructure and DevOps to IoT and mobile development,
            continuously expanding my knowledge to deliver optimal solutions.
          </Typography>
