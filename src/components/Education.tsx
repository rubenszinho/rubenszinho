...
export const Education: React.FC = () => {
  ...
  // Updated education with real information
  const education: EducationItem[] = [
    ...
    },
    {
      ...
      period: "2019",
      description: "Achieved A1 CEFR level certification in English proficiency, demonstrating advanced language skills in reading, writing, speaking and listening."
    }
  ];
    ...
    >
      <Container maxWidth="lg">
        ...
        >
          ...
          >
            My academic background and professional certifications that form the foundation of my expertise in software development and infrastructure.
          </Typography>
